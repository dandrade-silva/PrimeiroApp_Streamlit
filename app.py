...
def mostra_qntd_linhas(dataframe):
    ...
    qntd_linhas = st.sidebar.slider('Selecione a quantidade de linhas que deseja mostrar na tabela', min_value = 1, max_value = len(dataframe), step = 1, value=len(dataframe))
...
if checkbox_mostrar_tabela:
    st.sidebar.markdown('## Filtros para a tabela')
